...
class enrol_idpay_plugin extends enrol_plugin {
    ...
    function enrol_page_hook(stdClass $instance) {
        ...
        if (abs($cost) < 0.01) { // no cost, other enrolment methods (instances) should be used
            echo '<p>'.get_string('nocost', 'enrol_idpay').'</p>';
        } else {

            // Calculate localised and "." cost, make sure we send idpay the same value,
            // please note idpay expects amount with 2 decimal places and "." separator.
            ...
            if (isguestuser()) { // force login only for guest user, not real users with guest role
                ...
                //Sanitise some fields before building the idpay form
                ...
                include($CFG->dirroot.'/enrol/idpay/enrol.html');
            }
