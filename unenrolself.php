...
$instance = $DB->get_record('enrol', array('id'=>$enrolid, 'enrol'=>'idpay'), '*', MUST_EXIST);
...
$PAGE->set_url('/enrol/idpay/unenrolself.php', array('enrolid'=>$instance->id));
...
$message = get_string('unenrolselfconfirm', 'enrol_idpay', format_string($course->fullname));
