...
$PAGE->set_url('/enrol/idpay/edit.php', array('courseid'=>$course->id, 'id'=>$instanceid));
...
if ($instanceid) {
    $instance = $DB->get_record('enrol', array('courseid'=>$course->id, 'enrol'=>'idpay', 'id'=>$instanceid), '*', MUST_EXIST);
...
$PAGE->set_title(get_string('pluginname', 'enrol_idpay'));

echo $OUTPUT->header();
echo $OUTPUT->heading(get_string('pluginname', 'enrol_idpay'));
$mform->display();
echo $OUTPUT->footer();
